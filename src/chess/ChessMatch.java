...
public class ChessMatch {
	...
	private ChessPiece enPassantVulnerable; // nao iniciamos pq o valor começa como nulo
	...
	private Color opponent(Color color) {
		...
		// se color for igual Color.White então eu retorno Color.BLACK SENÃO retorno
		// Color.White
	}
